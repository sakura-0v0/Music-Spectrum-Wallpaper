...
def run_sound(
    ...
    try:
        run_fft_process(
            left_volume_value = kwargs["left_volume_value"],
            right_volume_value = kwargs["right_volume_value"]
        ) # 开启FFT处理进程
...
def sound_main():
    ...
    sound_p = multiprocessing.Process(
        ...
        kwargs={
            "left_volume_value": win_app_queues.left_volume_value,
            "right_volume_value": win_app_queues.right_volume_value,
    },
    name = "FFT主进程",
    # daemon=True
    )
    ...
    show_win = Show(
        ...
        win_app_queues.restart_queue,
        win_app_queues.left_volume_value,
        win_app_queues.right_volume_value,
    )
